        ...
        <>
            ...
            <Row gutter={[24, 0]}>
                <Col span={24} md={16} className="mb-24">
                    <Card className="header-solid h-full" bordered={false} title={[<h6 className="font-semibold m-0">Danh sách sản phẩm</h6>]} style={{ body:{paddingTop: "0" }}}>
                        <Row gutter={[24, 24]}>
